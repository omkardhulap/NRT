 ...
 */
public class MapMonthYearWiseComparator implements Comparator {

	private static Map<Locale, List> monthMap = new HashMap<Locale, List>();
	private static SimpleDateFormat dateFormat;

	public MapMonthYearWiseComparator(SimpleDateFormat dateFormat) {
	...
	public int compare(Object month1, Object month2) {
		try {
			...
			e.printStackTrace();
			throw new NullPointerException("MapMonthYearWiseComparator cannot perform comparison - " + e.getMessage());
		}
	}
}