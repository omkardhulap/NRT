...
* For the planned Outages, Snow ID is converted into Enhancements if any of the snow id 
* starts with ENHCXXXXXXX. This class defines variables for Enhancement Object.
* @author  Mital Gadoya
* @version 1.0
* @since   2015-01-01
*/
