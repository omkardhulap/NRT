...
<head>
	...
	<script type="text/javascript" charset="utf8" src="${pageContext.request.contextPath}/resources/js/searchMTTR.js"></script>
...
<!-- Search Criteria Section -->
	<c:url var="searchAction" value="/searchMTTR/search"></c:url>
	<form:form action="${searchAction}" id="formId" commandName="searchMTTR" method="GET">
		<fieldset>
			<legend>MTTR Analysis</legend>
		</fieldset>
			...
			<div class="form-group">
				<tr>
					...
					<td>
                        ...
                        <%-- <input id="exportBtn" type="button" class="btn btn-warning" title="Please select Excel Workbook while saving" value="CSV"/> --%>
                        <%-- <i>
							<b><a href="${pageContext.request.contextPath}/resources/templates/${user_id}_MTTRAnalysisReport.xlsx" target="_blank">Download</a></b>
						</i> --%> 
